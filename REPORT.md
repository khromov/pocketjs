...
Generated by `bun tools/bundle-size.ts` at 2026-09-06T06:11:13.365Z from git `798c44d` **with a dirty working tree** — these numbers are not reproducible from the committed tree alone.
...
Over 6 demos, Svelte is **1.78x** Solid as shipped and **1.53x** gzipped — **larger than Solid** on both.

Over 3 demos, Svelte is **0.79x** Vue Vapor as shipped and **0.55x** gzipped — **smaller than Vue Vapor** on both.

Over 2 demos, Svelte is **0.68x** Octane as shipped and **0.73x** gzipped — **smaller than Octane** on both.

Normalised against each other on `cards`, Svelte's runtime is **3.8x Solid's**, **26% smaller than Vue Vapor's** and **0.5x Octane's**. Against Solid that runtime is most of the whole
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 336.1 KiB | 237.1 KiB | **0.71x** | 157.3 KiB | 94.6 KiB | 44.4 KiB | 33.4 KiB | **0.75x** |
| `hero` | 339.5 KiB | 223.0 KiB | **0.66x** | 157.4 KiB | 88.8 KiB | 44.6 KiB | 31.4 KiB | **0.71x** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 281.7 KiB | 237.1 KiB | **0.84x** | 158.2 KiB | 94.6 KiB | 56.7 KiB | 33.4 KiB | **0.59x** |
| `hero` | 308.2 KiB | 223.0 KiB | **0.72x** | 166.9 KiB | 88.8 KiB | 60.1 KiB | 31.4 KiB | **0.52x** |
| `lab (vue-sfc-lab ↔ svelte-lab)` | 301.2 KiB | 244.4 KiB | **0.81x** | 169.9 KiB | 95.1 KiB | 60.9 KiB | 33.4 KiB | **0.55x** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 129.1 KiB | 237.1 KiB | **1.84x** | 60.0 KiB | 94.6 KiB | 21.1 KiB | 33.4 KiB | **1.58x** |
| `chrome` | 122.9 KiB | 217.9 KiB | **1.77x** | 56.3 KiB | 86.7 KiB | 19.9 KiB | 30.7 KiB | **1.55x** |
| `cursor` | 120.6 KiB | 226.0 KiB | **1.87x** | 55.0 KiB | 89.3 KiB | 19.8 KiB | 32.2 KiB | **1.62x** |
| `hero` | 133.1 KiB | 223.0 KiB | **1.68x** | 61.6 KiB | 88.8 KiB | 21.3 KiB | 31.4 KiB | **1.47x** |
| `launcher` | 138.5 KiB | 235.0 KiB | **1.70x** | 64.5 KiB | 95.5 KiB | 22.7 KiB | 34.0 KiB | **1.49x** |
| `motions` | 172.5 KiB | 320.2 KiB | **1.86x** | 90.6 KiB | 134.1 KiB | 25.9 KiB | 38.2 KiB | **1.48x** |
...
| Svelte | **83.1 KiB** | 68.8 KiB | 2.2 KiB | 7.8 KiB | 2.1 KiB | 164.0 KiB |
...
| --- | --- | ---: | ---: |
| Solid | `solid-js` | 21.6 KiB | 0.26x |
| Vue Vapor | `vue` | 112.9 KiB | 1.36x |
| Octane | `octane` | 163.2 KiB | 1.96x |
| Svelte | `svelte` | 83.1 KiB | 1.00x |
