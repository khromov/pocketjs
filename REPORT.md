...
Generated by `bun tools/bundle-size.ts` at 2026-09-06T05:26:34.343Z from git `178cb04` **with a dirty working tree** — these numbers are not reproducible from the committed tree alone.
...
Over 6 demos, Svelte is **1.87x** Solid as shipped and **1.60x** gzipped — **larger than Solid** on both.

Over 3 demos, Svelte is **0.83x** Vue Vapor as shipped and **0.58x** gzipped — **smaller than Vue Vapor** on both.

Over 2 demos, Svelte is **0.72x** Octane as shipped and **0.76x** gzipped — **smaller than Octane** on both.

Normalised against each other on `cards`, Svelte's runtime is **4.2x Solid's**, **19% smaller than Vue Vapor's** and **0.6x Octane's**. Against Solid that runtime is most of the whole
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 336.1 KiB | 248.9 KiB | **0.74x** | 157.3 KiB | 98.3 KiB | 44.4 KiB | 34.8 KiB | **0.78x** |
| `hero` | 339.5 KiB | 234.8 KiB | **0.69x** | 157.4 KiB | 92.5 KiB | 44.6 KiB | 32.8 KiB | **0.74x** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 281.7 KiB | 248.9 KiB | **0.88x** | 158.2 KiB | 98.3 KiB | 56.7 KiB | 34.8 KiB | **0.61x** |
| `hero` | 308.2 KiB | 234.8 KiB | **0.76x** | 166.9 KiB | 92.5 KiB | 60.1 KiB | 32.8 KiB | **0.55x** |
| `lab (vue-sfc-lab ↔ svelte-lab)` | 301.2 KiB | 256.2 KiB | **0.85x** | 169.9 KiB | 98.7 KiB | 60.9 KiB | 34.9 KiB | **0.57x** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 129.1 KiB | 248.9 KiB | **1.93x** | 60.0 KiB | 98.3 KiB | 21.1 KiB | 34.8 KiB | **1.65x** |
| `chrome` | 122.9 KiB | 229.7 KiB | **1.87x** | 56.3 KiB | 90.3 KiB | 19.9 KiB | 32.1 KiB | **1.62x** |
| `cursor` | 120.6 KiB | 237.8 KiB | **1.97x** | 55.0 KiB | 93.0 KiB | 19.8 KiB | 33.5 KiB | **1.69x** |
| `hero` | 133.1 KiB | 234.8 KiB | **1.76x** | 61.6 KiB | 92.5 KiB | 21.3 KiB | 32.8 KiB | **1.54x** |
| `launcher` | 138.5 KiB | 246.8 KiB | **1.78x** | 64.5 KiB | 99.2 KiB | 22.7 KiB | 35.4 KiB | **1.56x** |
| `motions` | 172.5 KiB | 331.9 KiB | **1.92x** | 90.6 KiB | 137.7 KiB | 25.9 KiB | 39.7 KiB | **1.53x** |
...
| Svelte | **91.1 KiB** | 69.1 KiB | 2.2 KiB | 7.8 KiB | 2.1 KiB | 172.2 KiB |
...
| --- | --- | ---: | ---: |
| Solid | `solid-js` | 21.6 KiB | 0.24x |
| Vue Vapor | `vue` | 112.9 KiB | 1.24x |
| Octane | `octane` | 163.2 KiB | 1.79x |
| Svelte | `svelte` | 91.1 KiB | 1.00x |
