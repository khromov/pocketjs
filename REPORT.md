...
Generated by `bun tools/bundle-size.ts` at 2026-09-06T05:52:33.337Z from git `c25d18b` **with a dirty working tree** — these numbers are not reproducible from the committed tree alone.
...
Over 6 demos, Svelte is **1.82x** Solid as shipped and **1.56x** gzipped — **larger than Solid** on both.

Over 3 demos, Svelte is **0.81x** Vue Vapor as shipped and **0.57x** gzipped — **smaller than Vue Vapor** on both.

Over 2 demos, Svelte is **0.70x** Octane as shipped and **0.74x** gzipped — **smaller than Octane** on both.

Normalised against each other on `cards`, Svelte's runtime is **4.0x Solid's**, **23% smaller than Vue Vapor's** and **0.5x Octane's**. Against Solid that runtime is most of the whole
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 336.1 KiB | 242.4 KiB | **0.72x** | 157.3 KiB | 96.6 KiB | 44.4 KiB | 34.1 KiB | **0.77x** |
| `hero` | 339.5 KiB | 228.3 KiB | **0.67x** | 157.4 KiB | 90.8 KiB | 44.6 KiB | 32.2 KiB | **0.72x** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 281.7 KiB | 242.4 KiB | **0.86x** | 158.2 KiB | 96.6 KiB | 56.7 KiB | 34.1 KiB | **0.60x** |
| `hero` | 308.2 KiB | 228.3 KiB | **0.74x** | 166.9 KiB | 90.8 KiB | 60.1 KiB | 32.2 KiB | **0.54x** |
| `lab (vue-sfc-lab ↔ svelte-lab)` | 301.2 KiB | 249.7 KiB | **0.83x** | 169.9 KiB | 97.1 KiB | 60.9 KiB | 34.2 KiB | **0.56x** |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `cards` | 129.1 KiB | 242.4 KiB | **1.88x** | 60.0 KiB | 96.6 KiB | 21.1 KiB | 34.1 KiB | **1.62x** |
| `chrome` | 122.9 KiB | 223.2 KiB | **1.82x** | 56.3 KiB | 88.7 KiB | 19.9 KiB | 31.5 KiB | **1.58x** |
| `cursor` | 120.6 KiB | 231.3 KiB | **1.92x** | 55.0 KiB | 91.3 KiB | 19.8 KiB | 32.8 KiB | **1.66x** |
| `hero` | 133.1 KiB | 228.3 KiB | **1.72x** | 61.6 KiB | 90.8 KiB | 21.3 KiB | 32.2 KiB | **1.51x** |
| `launcher` | 138.5 KiB | 240.3 KiB | **1.74x** | 64.5 KiB | 97.5 KiB | 22.7 KiB | 34.7 KiB | **1.53x** |
| `motions` | 172.5 KiB | 325.5 KiB | **1.89x** | 90.6 KiB | 136.1 KiB | 25.9 KiB | 39.0 KiB | **1.51x** |
...
| Svelte | **86.6 KiB** | 69.1 KiB | 2.2 KiB | 7.8 KiB | 2.1 KiB | 167.8 KiB |
...
| --- | --- | ---: | ---: |
| Solid | `solid-js` | 21.6 KiB | 0.25x |
| Vue Vapor | `vue` | 112.9 KiB | 1.30x |
| Octane | `octane` | 163.2 KiB | 1.88x |
| Svelte | `svelte` | 86.6 KiB | 1.00x |
