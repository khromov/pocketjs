<script lang="ts">
  // apps/motions — yui540 motion studies on baked keyframe timelines (Svelte).
  ...
  //
  // Left/Right on the d-pad switch pages. The per-study helpers the Solid
  // original writes as local components are `{#snippet}` blocks here, so the
  ...
  const PAGES: PageDef[] = [
    { title: "MOTIONS/53", source: "yui540.com/motions/53" },
    { title: "MOTIONS/56", source: "yui540.com/motions/56" },
    { title: "MOTIONS/30", source: "yui540.com/motions/30" },
    { title: "MOTIONS/64 · 3D", source: "yui540.com/motions/64" },
  ];

  let index = $state(0);
  const page = $derived(PAGES[index]);

  onButtonPress(BTN.RIGHT | BTN.RTRIGGER, () => {
    index = (index + 1) % PAGES.length;
  });
  onButtonPress(BTN.LEFT | BTN.LTRIGGER, () => {
    index = (index + PAGES.length - 1) % PAGES.length;
  });
</script>

{#snippet caption(label: string, light: boolean)}
  <View debugName="Caption" class="absolute left-0 bottom-[4] w-full flex-row justify-center">
    <Text
      class={light
        ? "text-xs font-bold text-[#f1f1f1] tracking-wide"
        : "text-xs font-bold text-[#888] tracking-wide"}>{label}</Text
    >
  </View>
{/snippet}
...
{#snippet menu53()}
  <View
    debugName="Menu53"
    class="absolute left-[10] top-[32] w-[38] h-[38] rounded-[19px] bg-white overflow-hidden animate-m53-menu-pill"
  >
    <View class="absolute left-[34] top-0 w-[38] h-[38]">
      <View
        class="absolute left-[4] top-[4] w-[30] h-[30] rounded-full bg-[#f1f1f1] flex-row justify-center items-center animate-m53-menu-item-1"
      >
    ...
    <View class="absolute left-[68] top-0 w-[38] h-[38]">
      <View
        class="absolute left-[4] top-[4] w-[30] h-[30] rounded-full bg-[#f1f1f1] flex-row justify-center items-center animate-m53-menu-item-2"
      >
    ...
    <View class="absolute left-[103] top-0 w-[38] h-[38]">
      <View
        class="absolute left-[4] top-[4] w-[30] h-[30] rounded-full bg-[#f1f1f1] flex-row justify-center items-center animate-m53-menu-item-3"
      >
    ...
    <View class="absolute left-0 top-0 w-[38] h-[38]">
      <View
        class="absolute left-[7] top-[17] w-[5] h-[5] rounded-[2px] bg-[#777] animate-m53-menu-x-left"
      />
      <View class="absolute left-[17] top-[17] w-[5] h-[5] rounded-[2px] bg-[#777]" />
      <View
        class="absolute left-[27] top-[17] w-[5] h-[5] rounded-[2px] bg-[#777] animate-m53-menu-x-right"
      />
    </View>
  </View>
  {@render caption("MENU", false)}
{/snippet}
...
{#snippet dpad53()}
  <Image
    debugName="DPad53"
    class="absolute left-[64] top-[34] w-[26] h-[11]"
    src="icon-base-down.svg"
  />
  ...
  <View
    class="absolute left-[92] top-[39] w-[24] h-[26] rounded-[5px] bg-[#888] animate-m53-dpad-right"
  >
    <Image class="absolute right-[4] top-[5] w-[15] h-[15]" src="icon-arrow-right.svg" />
  </View>
  <View
    class="absolute left-[64] top-[67] w-[26] h-[24] rounded-[5px] bg-[#888] animate-m53-dpad-down"
  >
    <Image class="absolute left-[6] bottom-[4] w-[15] h-[15]" src="icon-arrow-down.svg" />
  </View>
  <View
    class="absolute left-[38] top-[39] w-[24] h-[26] rounded-[5px] bg-[#888] animate-m53-dpad-left"
  >
    <Image class="absolute left-[4] top-[5] w-[15] h-[15]" src="icon-arrow-left.svg" />
  </View>
  {@render caption("D-PAD", false)}
{/snippet}
...
{#snippet share53()}
  <View
    debugName="Share53"
    class="absolute left-[33] top-[34] w-[38] h-[38] rounded-[11px] bg-white animate-m53-share-a"
  />
  <View
    class="absolute left-[83] top-[34] w-[38] h-[38] rounded-[11px] bg-white animate-m53-share-b"
  />
...
{#snippet hover53()}
  <View
    debugName="Hover53"
    class="absolute left-[23] top-[34] w-[108] h-[32] rounded-[9px] bg-white shadow overflow-hidden flex-row animate-m53-hover-btn"
  >
...
{#snippet reload53()}
  <View
    debugName="Reload53"
    class="absolute left-[41] top-[30] w-[38] h-[38] bg-white arc-width-[6] animate-m53-arc-a"
  />
  <View
    class="absolute left-[48] top-[37] w-[24] h-[24] flex-row justify-center items-center animate-m53-reload-icon-a"
  >
  ...
  <View
    class="absolute left-[90] top-[35] w-[28] h-[28] flex-row justify-center items-center animate-m53-reload-icon-b"
  >
    <Image class="w-[28] h-[28]" src="icon-reload.svg" />
  </View>
  {@render caption("RELOAD", false)}
{/snippet}
...
{#snippet keypad53()}
  <View debugName="Keypad53" class="absolute left-[16] top-[32] w-[34] h-[34]">
    <View
      class="absolute left-0 top-0 w-[34] h-[34] rounded-[10px] bg-[#e0e0e0] flex-row justify-center items-center animate-m53-key-1"
    >
  ...
  <View class="absolute left-[60] top-[32] w-[34] h-[34]">
    <View
      class="absolute left-0 top-0 w-[34] h-[34] rounded-[10px] bg-[#e0e0e0] flex-row justify-center items-center animate-m53-key-2"
    >
  ...
  <View class="absolute left-[104] top-[32] w-[34] h-[34]">
    <View
      class="absolute left-0 top-0 w-[34] h-[34] rounded-[10px] bg-[#e0e0e0] flex-row justify-center items-center animate-m53-key-3"
    >
...
{#snippet launch56()}
  <View
    debugName="Launch56"
    class="absolute left-[62] top-[31] w-[31] h-[31] overflow-hidden animate-m56-applaunch-box"
  >
    <View class="absolute inset-0 rounded-[11px] bg-[#888] animate-m56-applaunch-press" />
  </View>
  {@render caption("LAUNCH", false)}
{/snippet}
...
{#snippet heave56()}
  ...
  {@render caption("HEAVE-HO", false)}
{/snippet}

{#snippet ringCorner(cls1: string, cls2: string)}
  <View debugName="RingCorner" class={cls1} />
  <View class={cls2} />
{/snippet}
...
{#snippet focus56()}
  <View
    debugName="Focus56"
    class="absolute left-[23] top-[32] w-[34] h-[34] flex-row justify-center items-center"
  >
  ...
  <View class="absolute left-[60] top-[32] w-[34] h-[34]">
    <View class="absolute left-0 top-0 w-[34] h-[34] animate-m56-focus-ring">
      <View class="absolute inset-[-6] animate-m56-focus-pulse">
        {@render ringCorner(
          "absolute left-0 top-0 w-[11] h-[6] bg-[#ccc]",
          "absolute left-0 top-0 w-[6] h-[11] bg-[#ccc]",
        )}
        {@render ringCorner(
          "absolute right-0 top-0 w-[11] h-[6] bg-[#ccc]",
          "absolute right-0 top-0 w-[6] h-[11] bg-[#ccc]",
        )}
        {@render ringCorner(
          "absolute right-0 bottom-0 w-[11] h-[6] bg-[#ccc]",
          "absolute right-0 bottom-0 w-[6] h-[11] bg-[#ccc]",
        )}
        {@render ringCorner(
          "absolute left-0 bottom-0 w-[11] h-[6] bg-[#ccc]",
          "absolute left-0 bottom-0 w-[6] h-[11] bg-[#ccc]",
        )}
      </View>
    </View>
  </View>
  {@render caption("FOCUS", false)}
{/snippet}
...
{#snippet reveal30()}
  <View
    debugName="Reveal30"
    class="absolute left-[20] top-[12] w-[113] h-[71] bg-[#ccc] overflow-hidden shadow"
  >
    ...
    <View
      class="absolute left-0 top-0 w-full h-[50] flex-col justify-center items-center gap-1 animate-m30-reveal-logo"
    >
...
{#snippet grid30()}
  ...
  {@render caption("GRID", false)}
{/snippet}

{#snippet expand30()}
  <View
    debugName="Expand30"
    class="absolute left-[20] top-[12] w-[113] h-[71] rounded-[6px] bg-white border-[#ccc] border-2 overflow-hidden flex-col animate-m30-expand"
  >
...
{#snippet modal30()}
  ...
  <View
    class="absolute left-[43] top-[22] w-[67] h-[44] rounded-[6px] bg-white shadow-md flex-col items-center gap-1 pt-2 animate-m30-modal"
  >
  ...
  <View
    class="absolute left-[58] top-[71] w-[37] h-[13] rounded-[999px] bg-[#ccc] origin-bottom animate-m30-modal-btn"
  />
  {@render caption("MODAL", false)}
{/snippet}

{#snippet comments30()}
  <View
    debugName="Comments30"
    class="absolute left-[40] top-[26] w-[40] h-[28] rounded-[5px] bg-white shadow origin-bottom flex-col gap-1 p-1 animate-m30-comment-1"
  >
  ...
  <View
    class="absolute left-[101] top-[44] w-[40] h-[28] rounded-[5px] bg-white shadow origin-bottom flex-col gap-1 p-1 animate-m30-comment-2"
  >
    <View class="flex-row items-center gap-1">
      <View class="w-[6] h-[6] rounded-full bg-[#e0e0e0]" />
      <View class="w-[16] h-[3] rounded-[2px] bg-[#e0e0e0]" />
  ...
  <View
    class="absolute left-[74] top-[33] w-[31] h-[23] rounded-[999px] bg-white shadow origin-bottom flex-row justify-center items-center gap-1 animate-m30-bubble"
  >
    <View class="w-[4] h-[4] rounded-full bg-[#bbb]" />
    <View class="w-[4] h-[4] rounded-full bg-[#bbb]" />
    <View class="w-[4] h-[4] rounded-full bg-[#bbb]" />
  </View>
  {@render caption("COMMENTS", false)}
{/snippet}
...
<!-- Door: swings 110 degrees open about its right edge inside a framed wall. -->
{#snippet door64()}
  <View debugName="Door64" class="absolute left-[35] top-[14] w-[84] h-[62] bg-[#e0e0e0]">
    ...
    <View class="absolute left-[15] top-[10] w-[54] h-[41] perspective-[460]">
      ...
      <View class="absolute inset-0 origin-right animate-m64-door">
        ...
        <View
          class="absolute left-[9] top-[18] w-[16] h-[6] rounded-[3px] bg-[#888] origin-left animate-m64-knob"
        />
      </View>
    </View>
  </View>
  {@render caption("DOOR", false)}
{/snippet}

<!-- The six faces of a 28px cube (front/back z +/-14, sides folded 90 degrees). -->
{#snippet cubeFaces()}
...
{#snippet popOut64()}
  ...
  {@render caption("POP-OUT", false)}
{/snippet}

<!-- Stretch: the cube's width stretches while it yaws 30 degrees. -->
{#snippet stretch64()}
  <View debugName="Stretch64" class="absolute inset-0 opacity-70 perspective-[190]">
    <View
      class="absolute left-[60] top-[33] w-[34] h-[34] rotate-x-[-30] translate-z-[-17] animate-m64-stretch"
    >
...
{#snippet flip64()}
  ...
  {@render caption("FLIP", false)}
{/snippet}

<!-- Room: the camera sits inside a box that turns A -> B -> A. The letters are
     baked path textures riding the walls (TEX_TRI projection). -->
{#snippet room64()}
...
{#snippet tile(cls: string, study: Snippet)}
  <View debugName="Tile" class={cls}>
    {@render study()}
  </View>
{/snippet}
...
<View debugName="MotionsScreen" class="w-full h-full bg-[#191919]">
  ...
  {#if index === 0}
    {@render tile(TILE_POS[0], menu53)}
    {@render tile(TILE_POS[1], dpad53)}
    {@render tile(TILE_POS[2], share53)}
    {@render tile(TILE_POS[3], hover53)}
    {@render tile(TILE_POS[4], reload53)}
    {@render tile(TILE_POS[5], keypad53)}
  {:else if index === 1}
    {@render tile(TILE_POS[0], launch56)}
    {@render tile(TILE_POS[1], layout56)}
    {@render tile(TILE_POS[2], shutter56)}
    {@render tile(TILE_POS[3], cards56)}
    {@render tile(TILE_POS[4], heave56)}
    {@render tile(TILE_POS[5], focus56)}
  {:else if index === 2}
    {@render tile(TILE_POS[0], reveal30)}
    {@render tile(TILE_POS[1], grid30)}
    {@render tile(TILE_POS[2], expand30)}
    {@render tile(TILE_POS[3], modal30)}
    {@render tile(TILE_POS[4], comments30)}
    {@render tile(TILE_POS[5], slideIn30)}
  {:else}
    {@render tile(TILE_POS[0], door64)}
    {@render tile(TILE_POS[1], spin64)}
    {@render tile(TILE_POS[2], popOut64)}
    {@render tile(TILE_POS[3], stretch64)}
    {@render tile(TILE_POS[4], flip64)}
    {@render tile(TILE_POS[5], room64)}
  {/if}
  <View debugName="Footer" class="absolute left-0 bottom-[1] w-full flex-row justify-between px-[8]">
