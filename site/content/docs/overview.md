...
**Vue Vapor**, **Octane** or **Svelte** components; the build compiles class strings and
...
dynamic slots. Svelte compiles `.svelte` components against its custom-renderer
API. All four target the same retained native tree and HostOps
